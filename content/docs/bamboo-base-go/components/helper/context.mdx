...
func RequestContext() gin.HandlerFunc {
    return func(c *gin.Context) {
        ...
        // [!code highlight:3]
        // 3. 存储到 Gin Context
        c.Set(xConsts.RequestKey.String(), requestID)
        c.Set(xConsts.UserStartTimeKey.String(), time.Now())
...
func GetUser(ctx *gin.Context) {
    // [!code highlight:2]
    // 从 Gin Context 获取
    requestID := ctx.GetString(xConsts.RequestKey.String())
...
func TimingMiddleware() gin.HandlerFunc {
    return func(ctx *gin.Context) {
        ...
        // [!code highlight:4]
        // 获取开始时间并计算耗时
        if startTime, exists := ctx.Get(xConsts.UserStartTimeKey.String()); exists {
...
<Cards>
  <Card title="HTTP 日志" href="./http-logger" />
