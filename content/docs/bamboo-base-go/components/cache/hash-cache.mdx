...
```go
type HashCache[K any, F comparable, V any] interface {
    Get(ctx *gin.Context, key K, field F) (*V, bool, error)
    Set(ctx *gin.Context, key K, field F, value *V) error
    GetAll(ctx *gin.Context, key K) (map[F]V, error)
    SetAll(ctx *gin.Context, key K, fields map[F]*V) error
    Exists(ctx *gin.Context, key K, field F) (bool, error)
    Remove(ctx *gin.Context, key K, fields ...F) error
...
// [!code highlight:17]
// Get 获取单个配置项
func (c *UserConfigCache) Get(ctx *gin.Context, userID string, field string) (*string, bool, error) {
...
// [!code highlight:5]
// Set 设置单个配置项
func (c *UserConfigCache) Set(ctx *gin.Context, userID string, field string, value *string) error {
    key := "user:config:" + userID
...
// [!code highlight:13]
// GetAll 获取所有配置
func (c *UserConfigCache) GetAll(ctx *gin.Context, userID string) (map[string]string, error) {
    key := "user:config:" + userID
...
// [!code highlight:13]
// SetAll 批量设置配置
func (c *UserConfigCache) SetAll(ctx *gin.Context, userID string, fields map[string]*string) error {
    key := "user:config:" + userID
...
// [!code highlight:5]
// Exists 检查配置项是否存在
func (c *UserConfigCache) Exists(ctx *gin.Context, userID string, field string) (bool, error) {
    key := "user:config:" + userID
...
// [!code highlight:5]
// Remove 删除配置项
func (c *UserConfigCache) Remove(ctx *gin.Context, userID string, fields ...string) error {
    key := "user:config:" + userID
...
// [!code highlight:4]
// Delete 删除所有配置
func (c *UserConfigCache) Delete(ctx *gin.Context, userID string) error {
    key := "user:config:" + userID
...
// [!code highlight:11]
// GetTheme 获取用户主题
func (s *UserConfigService) GetTheme(ctx *gin.Context, userID string) (string, error) {
...
// [!code highlight:6]
// UpdateTheme 更新用户主题
func (s *UserConfigService) UpdateTheme(ctx *gin.Context, userID string, theme string) error {
    // 更新数据库
...
// [!code highlight:5]
// GetAllConfig 获取所有配置
func (s *UserConfigService) GetAllConfig(ctx *gin.Context, userID string) (map[string]string, error) {
...
// [!code highlight:2]
// ResetConfig 重置配置
func (s *UserConfigService) ResetConfig(ctx *gin.Context, userID string) error {
    // 删除数据库配置
...
```go
func (s *UserConfigService) UpdatePartial(ctx *gin.Context, userID string, updates map[string]string) error {
    fields := make(map[string]*string)
...
```go
func (c *UserConfigCache) SetMultipleUsers(ctx *gin.Context, configs map[string]map[string]*string) error {
    pipe := c.RDB.Pipeline()
