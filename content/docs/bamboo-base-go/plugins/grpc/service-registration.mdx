...
func main() {
    // 1. 初始化框架
    reg := xReg.Register(startup.Init(), nil)  // v1.0.5 起：nodeList 为必填，无业务节点传 nil
...
<Cards>
  <Card title="Proto 文件组织" href="/docs/bamboo-base-go/grpc/proto-organization" />
  <Card title="Handler 实现模式" href="/docs/bamboo-base-go/grpc/handler-pattern" />
